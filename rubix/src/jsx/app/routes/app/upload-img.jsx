                ...
                <Panel>
                  ...
                  <PanelBody>
                    <Grid>
                      <Row>
                        <Col xs={12} >
                          <h3>upload image for cropping or choose from files below</h3>
                          <input type='file' id="imgInp" style={{padding:10}}/>
                        </Col>
                      </Row>
                    </Grid>
                    <Grid>
                      <Row>
                        <Col sm={7}>
                          <img src='/imgs/unsplash/hot-air-baloon.jpg' className="crop" id="image-crop" ref='aspectwithpreview' alt='[Jcrop example]' width='100%' height='350' />
                        </Col>
                        <Col sm={5} >
