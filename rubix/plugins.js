...
gulp.task('minifyplugins', function() {
  gulp.src([
    ...
    '../public/js/vendor/bootstrap-cropping/bootstrap-cropping.js',
    ...
    '../public/js/vendor/bootstrap-switch/bootstrap-switch.min.js',
    ...
    '../public/js/vendor/jquery.location-picker/jquery-location-picker.min.js',
